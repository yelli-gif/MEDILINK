...
interface NotificationTraitementProps {
  message: string;
  link?: string;
  priseId?: string | number;
}

export default function NotificationTraitement({ message, link, priseId }: NotificationTraitementProps): React.JSX.Element | null {
