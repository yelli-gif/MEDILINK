    ...
    <div className="bg-background font-body text-on-surface antialiased min-h-screen">
      ...
      <header className="bg-[#faf8ff]/80 dark:bg-slate-950/80 backdrop-blur-xl shadow-[0_20px_40px_rgba(25,27,36,0.04)] fixed top-0 z-50 flex justify-between items-center px-8 h-20 w-full">
        <div className="flex items-center gap-4 cursor-pointer" onClick={() => navigate('/')}>
          <span className="text-2xl font-black font-manrope text-[#191b24] dark:text-slate-50">Sanctuary Admin</span>
        </div>
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-surface-container-low rounded-full">
            ...
            <span className="text-xs font-medium text-secondary uppercase tracking-wider">Secure Establishment Setup</span>
          </div>
      ...
      <main className="pt-32 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <div className="mb-16 text-left max-w-2xl">
          <h1 className="font-headline font-extrabold text-4xl sm:text-5xl tracking-tight text-on-surface mb-4">
            Establish your <span className="text-primary">Pharmacy</span>
          </h1>
          <p className="text-lg text-secondary leading-relaxed">
            Begin by defining the core identity and administrative leadership for your new clinical facility within the Sanctuary Health ecosystem.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_20px_40px_rgba(25,27,36,0.02)]">
              <label className="block text-xs font-bold uppercase tracking-widest text-primary mb-6">Facility Identification</label>
              <div className="relative">
                <input className="w-full bg-surface-container-highest border-none rounded-md px-6 py-4 text-lg focus:ring-2 focus:ring-primary/40 transition-all placeholder:text-outline outline-none" placeholder="e.g. Oak Ridge Pharmaceutical Center" type="text"/>
              </div>
            </div>
            ...
            <div className="bg-surface-container-low p-8 rounded-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-headline font-bold text-xl">Create Admin</h2>
              </div>
              <p className="text-sm text-secondary mb-8">Designate the primary controller for this establishment. They will receive invitation credentials via secure channel.</p>
              <div className="grid grid-cols-1 gap-6">
                <div>
                  <label className="block text-xs font-medium text-on-surface-variant mb-2 ml-1">Full Legal Name</label>
                  <input className="w-full bg-surface-container-lowest border-none rounded-md px-5 py-3 focus:ring-2 focus:ring-primary/40 transition-all outline-none" placeholder="Dr. Julian Vane" type="text"/>
                </div>
                <div>
                  <label className="block text-xs font-medium text-on-surface-variant mb-2 ml-1">Professional Email</label>
                  <input className="w-full bg-surface-container-lowest border-none rounded-md px-5 py-3 focus:ring-2 focus:ring-primary/40 transition-all outline-none" placeholder="j.vane@sanctuaryhealth.com" type="email"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-5 space-y-8">
            <div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_20px_40px_rgba(25,27,36,0.02)] h-full flex flex-col">
              <label className="block text-xs font-bold uppercase tracking-widest text-primary mb-6">Physical Position</label>
              <div className="relative mb-6">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-outline" data-icon="location_on">location_on</span>
                <input className="w-full bg-surface-container-highest border-none rounded-md pl-12 pr-6 py-4 focus:ring-2 focus:ring-primary/40 transition-all outline-none" placeholder="Enter street address..." type="text"/>
              </div>
              {/* Map Placeholder / Glass Visual */}
              <div className="flex-grow min-h-[300px] rounded-xl overflow-hidden relative group">
                <img alt="Map View" className="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 transition-all duration-700 absolute inset-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCOEU1QNwOLWXawixPAZR_y3cv5C-ep0nnLQxZS_Q23kBLAvdHI0-BUss3MXEEwzyJMdXxh-US_wkefwli-a3YuBFAnPi7udmLUm1t5Bhqxwe7SMROjnBbEC-TsRsln0JxAJUGy3MBNd9TNpdACG96mD6YOUx7C7axcortgknw6aiLlQEHJPxpJOH2ULIgHcpWE4JoSzXNZWImV2J6-YV-mF-hIY_rzwInyNNJiGSOP3c4pDqJCtU2yDL7Qh7F8SFEGZW9jg0DdXjo"/>
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/60 backdrop-blur-md p-4 rounded-lg border border-white/40">
                  <p className="text-[10px] uppercase font-bold tracking-widest text-primary mb-1">Geographic Coordinates</p>
        ...
        {/* Sticky Action Bar (Task Focused) */}
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between p-6 sm:p-8 bg-surface-container-highest/50 rounded-2xl backdrop-blur-sm gap-6">
          <div className="flex items-center gap-4 w-full sm:w-auto">
            ...
            <span className="text-sm font-medium text-secondary">Drafting Establishment Identity</span>
          </div>
      ...
      <footer className="flex flex-col sm:flex-row justify-between items-center px-12 mt-auto w-full py-6 font-body text-xs text-[#586766] gap-4">
        <div className="flex items-center gap-2 text-center sm:text-left">
          ...
          <span>© 2024 Sanctuary Health Systems. Encrypted & Secure.</span>
        </div>
        <div className="flex gap-4 sm:gap-8">
          <a className="text-[#586766] hover:text-[#0066FF] transition-colors" href="#">Privacy Policy</a>
          <a className="text-[#586766] hover:text-[#0066FF] transition-colors" href="#">Terms of Service</a>
          <a className="text-[#586766] hover:text-[#0066FF] transition-colors" href="#">System Status</a>
        </div>
      </footer>
    </div>
  );
