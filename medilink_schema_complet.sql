...
CREATE TABLE IF NOT EXISTS hopital (
    ...
    localisation  GEOMETRY       NULL,               -- Point GPS (JTS / PostGIS)
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS patient (
    ...
    poids           INT           NULL,
    localisation    POINT         NULL SRID 4326,    -- Coordonnées GPS du patient
    antecedents     TEXT          NULL,
    created_at      TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
);

-- Rendez-vous (utilisé par Lot 1, Lot 2, Lot 3 et Lot 4)
...
CREATE TABLE IF NOT EXISTS ordonnance (
    ...
    date_debut_traitement   TIMESTAMP    NULL,
...
CREATE TABLE IF NOT EXISTS pharmacie (
    ...
    adresse       VARCHAR(500)  NOT NULL,
    localisation  GEOMETRY      NULL,               -- Point GPS de la pharmacie
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS demande_disponibilite (
    ...
    ligne_ordonnance_id BIGINT  NULL,               -- Quelle ligne d'ordonnance est concernée
    pharmacie_id     BIGINT     NULL,
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS prise_medicament (
    id                BIGINT       NOT NULL AUTO_INCREMENT,
    date_heure_prevue TIMESTAMP    NULL,            -- Quand le patient devait prendre
    date_heure_prise  TIMESTAMP    NULL,            -- Quand il a réellement pris
    statut_prise      VARCHAR(50)  NULL,            -- PRISE | OUBLIEE | RETARD
    commentaire       VARCHAR(500) NULL,
    ligne_ordonnance_id BIGINT     NULL,            -- Lien vers la ligne d'ordonnance
    patient_id        BIGINT       NULL,
    PRIMARY KEY (id),
